...
import { parseHexColor } from '../utils/gradientUtils.js';
...
export const GradientPreviewWidget = GObject.registerClass({
    ...
    _dragStartX;
    _dragStartPosition;
    constructor(gradientStops, angle = 90) {
        super({
            content_height: 80,
            content_width: 400,
            hexpand: true,
    ...
    _onPressed(_gesture, nPress, x, y) {
    ...
    _onReleased(_gesture, _nPress, _x, _y) {
        this._draggedStop = -1;
        this.queue_draw();
    }
    _onDragBegin(_gesture, startX, startY) {
    ...
    _onDragEnd(_gesture, _offsetX, _offsetY) {
